...
public class SupplyAsyncTest {
    ...
    public void thenApply() throws ExecutionException, InterruptedException {
        ...
        completableFuture = completableFuture.thenApply((s) -> s.concat("!"));
    ...
    public void thenCompose() throws ExecutionException, InterruptedException {
        CompletableFuture<String> composedCompletableFuture = CompletableFuture
                .supplyAsync(() -> "Future")
                .thenCompose(s -> CompletableFuture.supplyAsync(() -> s.concat(" is awesome!")));
    ...
    public void thenCombine() throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<String> combinedCompletableFuture = completableFuture1.thenCombine(completableFuture2, (s1, s2) -> s1.concat(s2));
    ...
    public void thenAccept() throws ExecutionException, InterruptedException {
        ...
        completableFuture = completableFuture.thenApplyAsync((s) -> s.concat(" is awesome!"));
        CompletableFuture<Void> procedureFuture = completableFuture.thenAccept(System.out::println);
    ...
    public void thenRun() throws ExecutionException, InterruptedException {
        ...
        completableFuture = completableFuture.thenApplyAsync((s) -> s.concat(" is awesome!"));
        CompletableFuture<Void> procedureFuture = completableFuture.thenRun(() -> System.out.println("!"));
